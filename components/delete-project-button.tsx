...
export function DeleteProjectButton({
  ...
  return (
    <button
      onClick={remove}
      disabled={pending}
      className="rounded-sm border border-paper-line px-3 py-1.5 font-mono text-[10px] tracking-[0.16em] text-ink-mute transition hover:border-rust hover:text-rust disabled:opacity-50"
    >
