...
// so a note's `folder` value is a building key (e.g. "THE_WELLNESS_CENTER") —
...
const LEGACY_FOLDER_TO_BUILDING: Record<string, string> = {
  ...
  writing: "THE_PRESS",
  travel: "THE_PORT",
  misc: "THE_WELLNESS_CENTER", // only ever held one note (the 50 First Dates tape); Tracy's call
};
